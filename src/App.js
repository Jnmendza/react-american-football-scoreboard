    ...
    <div className="container">
      <section className="scoreboard">
        <div className="title-container">
          <h1 className="title">FOOTBALL SCOREBOARD</h1>
        </div>
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          setHome(home + 7)}>Home Touchdown</button>
          <button className="homeButtons__fieldGoal" onClick={() => 
          setHome(home + 3)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => 
          setAway(away + 7)}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={() => 
          setAway(away + 3)}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
